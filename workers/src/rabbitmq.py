...
class BasicRabbitBroker(MessageBroker):
    ...
    async def on_message(self, _unused_channel, basic_deliver, properties, body):
        ...
        LOGGER.debug('Message # %s from %s: %s',
                    basic_deliver.delivery_tag, properties.app_id, body)
        self.acknowledge_message(basic_deliver.delivery_tag)
        await self.action_cb(body)
...
class RabbitBroker(object):
    ...
    def __init__(self, amqp_url, action_cb):
        ...
        self._consumer = BasicRabbitBroker(self._amqp_url, self.action_cb)
